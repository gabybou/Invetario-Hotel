<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Empleado.aspx.cs" Inherits="Ver" %>
...
<body>
   ...
   <!-- Header -->
	    <header id="header" style="background-position: left 0px;">
            ...
            <h3><label>Empleador</label></h3>                 
            <br/><br/>
            <asp:Button ID="BtnSalir" type="submit" Text="Salir" runat="server" Onclick="BtnSalir_Click" ></asp:Button>
            <br/><br/>
		    </div>
	    </header>
	<!-- Main -->
	<div id="main">
    <!-- Two -->
	    <h2 style="text-align: center; color: white; background-color: #a50e0e; margin-left: -16%; width: 146.4%; margin-top: -1.8%;">MI PERFIL</h2>
        <div class="row">
            <div class="col-xs-12 col-md-3">
                
                <div class="input-group">
                        <asp:TextBox  runat="server" ID="CodEmpleado" type="text" CssClass="form-control" placeholder="Ingrese codigo empleado" style="width:587%; visibility: hidden; "></asp:TextBox>
                ...
                <div class="form-group" style="width:550%"; >
                     ...
                     <div class="input-group">
                        <asp:TextBox  runat="server" ID="nombres" type="text" CssClass="form-control" placeholder="Nombres" style="width:70%;"></asp:TextBox>
                     ...
                     <div class="input-group">
                        ...
                        <asp:RegularExpressionValidator ID="RegularDui" runat="server"  ControlToValidate="Dui"  ValidationExpression="^\d{8}\-\d{1}" style="visibility: visible;" ErrorMessage="NIT incorrecto"></asp:RegularExpressionValidator>
                         <span class="input-group-addon">-</span>
                        <asp:TextBox runat="server" ID="genero" type="text" Cssclass="form-control" placeholder="Genero" style="width: 70%; top: 0px; left: 0px;"></asp:TextBox>
                     ...
                     <div class="input-group">
                        <asp:TextBox  runat="server" ID="sueldo" type="text" CssClass="form-control" placeholder="Costo" style="width:70%;"></asp:TextBox>
