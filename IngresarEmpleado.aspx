<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IngresarEmpleado.aspx.cs" Inherits="IngresarEmpleado" %>
...
<body>
    <form id="form1" runat="server">
	    ...
	    <header id="header" style="background-position: left 0px;">
            ...
            <asp:Button ID="btnDescartar" type="submit" Text="Descartar" runat="server" OnClick="btnDescartar_Click"></asp:Button>
            <br/><br/>
            <asp:Button ID="BtnAgregar" type="submit" Text="Agregar" runat="server" OnClick="BtnAgregar_Click"></asp:Button>
            <br/><br>
	...
	<div id="main">
    <!-- Two -->
	    <h2 style="text-align: center; color: white; background-color: #a50e0e; margin-left: -16%; width: 146.4%; margin-top: -1.8%;">Agregar Productos</h2>
        <div class="row">
            <div class="col-xs-12 col-md-3">
                 <div class="form-group" style="width:550%"; >
                      <label for="">Datos del Producto</label>                        
                     <div class="input-group">
                        <asp:TextBox  runat="server" ID="nombres" type="text" CssClass="form-control" placeholder="Nombre Producto" style="width:70%;"></asp:TextBox>
                     ...
                     <div class="input-group">
                        <asp:Textbox runat="server" name="dui" id="dui" Cssclass="form-control" type="text" placeholder="Codigo del Producto" style="width: 35%; margin-right: 18.5%;"/>
                     ...
                     <div class="input-group">
                        ...
                        <asp:RegularExpressionValidator ID="RegularTelefono" runat="server"  ControlToValidate="telefono"  ValidationExpression="^\d{4}\-\d{4}" style="visibility: visible;margin-left: -18%;" ErrorMessage="Tel incorrecto"></asp:RegularExpressionValidator>
                      ...
                      <div class="input-group">
                        ...
                        <asp:RegularExpressionValidator ID="RegularSalario" runat="server"  ControlToValidate="sueldo"  ValidationExpression="^\$(\d{1,3},?(\d{3},?)*\d{3}(.\d{0,3})?|\d{1,3}(.\d{2})?)$" style="visibility: hidden;" ErrorMessage="SuelIncorrecto"></asp:RegularExpressionValidator>
                         <span class="input-group-addon">-</span>
                        <asp:TextBox runat="server" ID="fecha" type="text" Cssclass="form-control" placeholder="yyyy-mm-dd" style="width: 70%;"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularFechaIng" runat="server"  ControlToValidate="fecha"  ValidationExpression="([12]\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01]))" style="visibility: visible;" ErrorMessage="fechincorrecto"></asp:RegularExpressionValidator>
                     </div>
             ...
             <div class="input-group">
                   <asp:TextBox  runat="server" ID="usuario" type="text" CssClass="form-control" placeholder="Codigo de Empleado" style="width:70%;"></asp:TextBox>
                   <asp:RegularExpressionValidator ID="RegularUsuario" runat="server"  ControlToValidate="usuario"  ValidationExpression="[A-Z]{4}\d{1}" style="visibility: visible;" ErrorMessage="Uss incorrecto"></asp:RegularExpressionValidator>
                   <span class="input-group-addon">-</span>
                   <asp:TextBox runat="server" ID="clave" type="password" Cssclass="form-control" placeholder="Contraseña(Mays.Minus.Num.Simb.8min)" style="width: 70%;"></asp:TextBox>
                   <asp:RegularExpressionValidator ID="RegularContraseña" runat="server"  ControlToValidate="clave"  ValidationExpression="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" style="visibility: hidden;" ErrorMessage="Pas incorrecto"></asp:RegularExpressionValidator>
             </div>       
