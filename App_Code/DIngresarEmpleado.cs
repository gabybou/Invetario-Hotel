...
/// </summary>
public class DIngresarEmpleado
{
    ...
    public DIngresarEmpleado(string empleadoid, string nombre, string apellido, string edad, string genero, string fecha_ingreso,
    ...
    public string Ingresar(DIngresarEmpleado empleado)
    {
        string rpta = "";
        ...
        try
        {
            ...
            SqlCmd.CommandText = "spingresar_empleado";
